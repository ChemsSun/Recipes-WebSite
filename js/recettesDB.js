let recettesDB = [
  ...
  },
  {
    ...
    country: "Turquie",
    duration: "1 heur",
    image:"/assets/recettes/10/2.png",
    ingredients: [
      "Viande hachée (500g)",
  ...
  //*********************** */
  {
    ...
    country: "Algérien",
    duration: "1h30min",
    image:"/assets/recettes/11/2.png",
    ingredients: [
    ...
    instructions: [
      "Mélangez la semoule, le beurre et le sucre. Bien sabler avec les mains",
      "Laissez reposer 1 heure",
      "Lancez la cuisson du sirop : Dans une grande casserole, mettre l'eau, le sucre et la fleur d'oranger. Portez à ébullition pendant 15 minutes.",
      "Ajoutez la fleur d'oranger petit à petit à votre préparation de semoule.",
      "Ne pas pétrir. Juste mélanger avec le bout des doigts pour faire dissoudre le sucre.",
      "Beurrez un moule de 24 cm et mettez-y votre préparation.",
      "Tassez bien pour avoir une surface uniforme",
      "Découpez à l'aide d'un couteau des carrés ou losanges,",
      "Quand vous découpez, faites un mouvements. Je rentre le couteau et je le retire, pas d'une traite afin que la semoule ne se décolle pas",
      "Piquez les carrés avec les amandes entières",
      "Enfournez dans un four préchauffé à 200°c pendant 1 heure, en tournant le plateau de temps en temps",
      "Dés sa sortie du four, arrosez avec le sirop. Vous allez entendre un bruit, comme fffffchchhchchchch",
      "Utilisez une louche pour arrosez et faites-le doucement",
      "Mettez plus que la moitié du sirop. Remettre le plateau dans le four éteint",
      "Quand kalb el louz aura tout absorbé, rajoutez le sirop jusqu'à ce qu'au toucher vous obteniez un kalb el louz super tendre",
      "Ilest possible que l'on n'utiliser pas tout. Mais, on en mettra assez afin que la semoule soit super tendre et kalb el louz fondant",
    ],
    comments: [
      {
        user: "Saliha",
        rating: 4.5,
        content: "Très bon dessert dans le Ramadan, Saha Ramdankom",
      },
      {
        user: "Belkacem",
        rating: 5,
  ...
  // ***********************
  {
    ...
    country: "Amérique",
    duration: "50 minutes",
    image:"/assets/recettes/12/2.png",
    ingredients: [
      "1 pâte sablée",
      "4 œufs",
      "150 g de sucre",
    ...
    instructions: [
      ...
      "Déroulez votre pâte sablée dans un moule à tarte et piquez le fond avec une fourchette.",
      "Faites cuire la pâte à blanc pendant environ 15 minutes.",
      "Pendant ce temps, dans un saladier, fouettez les œufs avec le sucre jusqu'à ce que le mélange blanchisse.",
      "Ajoutez le jus de citron et le zeste râpé d'un citron, puis mélangez bien.",
      "Dans une casserole, faites fondre le beurre à feu doux. Ajoutez-le ensuite à la préparation précédente en fouettant vigoureusement.",
      "Versez la préparation sur la pâte cuite et enfournez pendant environ 20 minutes, jusqu'à ce que la tarte soit dorée.",
      "Laissez refroidir et mettez au frais avant de servir.",
    ],
    comments: [
      {
        user: "Maria",
        rating:3,
        content: "J'ai pas Trop aimé,la patte est un peu sucrée",
      },
      {
        user: "Zaki",
        rating: 4.7,
        content: "C'est une recette réussite",
      },
    ],
  },
  // *********************
  {
    ...
    country: "Palestine",
    duration: "45 minutes",
    image:"/assets/recettes/13/2.png",
    ingredients: [
      "500 g de pâte filo ",
      ...
      "1/2 tasse de sirop de glucose (disponible en magasin d'alimentation spécialisé",
      "1/2 tasse de pistaches hachées (ou d'autres noix comme les amandes ou les noix de cajou)",
    ],
    instructions: [
      "Préchauffez le four à 180°C (thermostat 6).",
      "Coupez la pâte filo en petits morceaux et mettez-la dans un bol. Ajoutez le beurre fondu et mélangez bien.",
      "Dans un moule à gâteau, étalez une fine couche de pâte filo, en appuyant bien pour former une croûte. Réservez le reste de la pâte filo.",
      "Dans un autre bol, mélangez le fromage blanc avec les pistaches hachées.",
      "Versez le mélange de fromage sur la croûte de pâte filo dans le moule à gâteau.",
      "Étalez le reste de la pâte filo sur le mélange de fromage blanc, en pressant doucement pour l'aplatir.",
      "Mettez le moule à gâteau au four pendant environ 30 minutes, ou jusqu'à ce que la pâte filo soit dorée.",
      "Pendant que la Kounafa cuit, préparez le sirop de sucre en mélangeant le sucre, l'eau et le jus de citron dans une casserole à feu moyen. Remuez jusqu'à ce que le sucre soit dissous, puis ajoutez le sirop de glucose. Faites cuire le sirop jusqu'à ce qu'il épaississe légèrement, environ 5 à 7 minutes.",
      "Retirez la Kounafa du four et versez le sirop de sucre chaud sur le dessus, en veillant à ce qu'il s'infiltre bien entre les couches de pâte filo.",
      "Laissez la Kounafa reposer pendant environ 10 à 15 minutes pour que le sirop soit bien absorbé.",
      "Servez chaud et savourez ce délicieux dessert traditionnel !",
    ],
    comments: [
      {
        user: "Chems Dhiet",
        rating: 4.9,
        content: "C'est trop bon comme dessert j'ai trés adorée",
      },
      {
        user: "Said",
        rating: 4,
        content: "J'ai aimé,mais un peu sucrée ",
      },
    ],
  },
];
